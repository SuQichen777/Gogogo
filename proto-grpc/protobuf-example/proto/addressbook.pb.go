...
type Person_PhoneNumber struct {
	...
	Type          PhoneType              `protobuf:"varint,2,opt,name=type,proto3,enum=testGo.PhoneType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_addressbook_proto_rawDesc = "" +
	"\n" +
	"\x11addressbook.proto\x12\x06testGo\x1a\x1fgoogle/protobuf/timestamp.proto\"\x83\x02\n" +
	"\x06Person\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x05R\x02id\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x122\n" +
	"\x06phones\x18\x04 \x03(\v2\x1a.testGo.Person.PhoneNumberR\x06phones\x12=\n" +
	"\flast_updated\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vlastUpdated\x1aL\n" +
	"\vPhoneNumber\x12\x16\n" +
	"\x06number\x18\x01 \x01(\tR\x06number\x12%\n" +
	"\x04type\x18\x02 \x01(\x0e2\x11.testGo.PhoneTypeR\x04type\"5\n" +
	"\vAddressBook\x12&\n" +
	"\x06people\x18\x01 \x03(\v2\x0e.testGo.PersonR\x06people*h\n" +
	"\tPhoneType\x12\x1a\n" +
	"\x16PHONE_TYPE_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11PHONE_TYPE_MOBILE\x10\x01\x12\x13\n" +
	"\x0fPHONE_TYPE_HOME\x10\x02\x12\x13\n" +
	"\x0fPHONE_TYPE_WORK\x10\x03B8Z6Gogogo/proto-grpc/protobuf-example/proto/testGo;testGob\x06proto3"
...
var file_addressbook_proto_goTypes = []any{
	(PhoneType)(0),                // 0: testGo.PhoneType
	(*Person)(nil),                // 1: testGo.Person
	(*AddressBook)(nil),           // 2: testGo.AddressBook
	(*Person_PhoneNumber)(nil),    // 3: testGo.Person.PhoneNumber
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_addressbook_proto_depIdxs = []int32{
	3, // 0: testGo.Person.phones:type_name -> testGo.Person.PhoneNumber
	4, // 1: testGo.Person.last_updated:type_name -> google.protobuf.Timestamp
	1, // 2: testGo.AddressBook.people:type_name -> testGo.Person
	0, // 3: testGo.Person.PhoneNumber.type:type_name -> testGo.PhoneType
